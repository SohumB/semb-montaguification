...
\begin{itemize}
\item (a) \emph{The town regulations require that there be no trespassing.}
\item (b) \emph{The town regulations require that all trespassers be fined.}
\item (c) \emph{The town regulations require that no trespassers be fined.}
\end{itemize}
